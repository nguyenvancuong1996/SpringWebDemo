								...
								<nav aria-label="Contacts Page Navigation">
									<ul class="pagination justify-content-center m-0">
										...
										<li
											...
											class="page-link"
											href="/Assigment_BackEnd/customers/listCustomer?page=${customers.number}">&larr;</a></li>
										<c:forEach var="pageCur" begin="${pager.startPage}" end="${pager.endPage}" step="1" varStatus="loop">
											<li
												...
												<a class="page-link"
												href="/Assigment_BackEnd/customers/listCustomer?page=${pageCur}">${loop.count}</a>
											</li>
										</c:forEach>
										<li
											class='${(customers.number + 1 == customers.totalPages ? "disabled page-item" : "page-item")}'>
											<a class="page-link"
											href="/Assigment_BackEnd/customers/listCustomer?page=${customers.number + 2}">&rarr;</a>
										</li>
										<li
											class='${(customers.number + 1 == customers.totalPages ? "disabled page-item" : "page-item")}'>

											<a class="page-link"
											href="/Assigment_BackEnd/customers/listCustomer?page=${customers.totalPages}">&raquo;</a>
										</li>
