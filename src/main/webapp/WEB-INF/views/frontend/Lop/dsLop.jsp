					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow"><a
							...
							aria-expanded="false"><span
								...
								src="${context}/resources/img/undraw_profile.svg"> </a> <!-- Dropdown - User Information -->
							<div
					...
					<div class="card">
						<div class="card-header">
							...
							<span class="float-left"
								...
								Danh Sách Lớp </span> <span class="float-right btn  btn-sm"> <a
								type="submit" href="/Assigment_BackEnd/lop/"
							...
							<tbody>
								<c:forEach var="item" items="${listClass}">
									<tr>
										...
										<td>${item.tenGV2}</td>
										<td>${item.tenLop}</td>
										<td>${item.soLuongTre}</td>
										<td>${item.ngayKhaiGiang}</td>
										<td>${item.ngayBeGiang}</td>
						...
						<div class="card-footer" style="text-align: center;">
							...
							<nav aria-label="Contacts Page Navigation">
								<ul class="pagination justify-content-center m-0">
									<li class=""><a class="page-link" href="">&laquo;</a></li>
									<li class=""><a class="page-link" href="">&larr;</a></li>
									<li class="" each=""><a class="page-link" href="" text="">1</a></li>
									<li class="" each=""><a class="page-link" href="" text="">2</a></li>
									<li class="" each=""><a class="page-link" href="" text="">3</a></li>
									<li class=""><a class="page-link" href="">&rarr;</a></li>
									<li class=""><a class="page-link" href="">&raquo;</a></li>
								</ul>
							</nav>
						</div>
					</div>
