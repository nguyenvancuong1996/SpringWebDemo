...
<head>
<meta charset="UTF-8">
<title>Quản Lý Theo Doi Vắng</title>
...
<body>
					...
					<div class="card">
						<div class="card-header">
							...
							<span class="float-left"
								...
								Them Moi Theo Doi Vang</span><span class="float-right btn  btn-sm">
								<a type="submit" href="/Assigment_BackEnd/theodoivang/list"
								class="btn btn-primary">Danh Sách</a>

							</span>
						</div>
						<div class="card-body">
							<form:form action="/Assigment_BackEnd/theodoivang/saveOrUpdate"
								modelAttribute="theodoivang" method="post"
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<form:select path="tre" id="matre" class="form-control">
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Ngày Nghĩ Dụng</label>
									<div class="col-sm-9">
										<form:input path="ngayNghi" type="text" id="datemask"
											class="form-control" data-inputmask-inputformat="dd/mm/yyyy"
											im-insert="false" data-inputmask-alias="datetime"
											placeholder="Ngày Nghĩ..." />
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Thời Gian Nghĩ</label>
									<div class="col-sm-9">
										<form:input path="thoiGianNghi" type="text"
											class="form-control" placeholder="Thời Gian Nghĩ..." />
										<div class="valid-feedback">OK</div>
										<div class="invalid-feedback"></div>
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<form:input path="lyDo" type="text" id="lydo"
								...
								<div class="form-group row">
									<label class="col-sm-3 col-form-label">Ăn Bán Trú</label>
									<div class="col-sm-9">
										<form:input path="anBanTru" type="text" id="anbantru"
											class="form-control" placeholder="Ăn Bán Trú..." />
										<div class="valid-feedback">OK</div>
										<div class="invalid-feedback"></div>
	...
	<script src="${context}/resources/validate/validateSDMay.js"></script>
